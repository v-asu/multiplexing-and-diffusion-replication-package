...
out_complex = run_multiple_simulations(G_list[vlg], q_list, tau, delta_list, m_iter, n_sims)

## save the results
np.save(SIMS_DIR / f"sim_complex_contagion_village_{vlg}.npy", out_complex)
